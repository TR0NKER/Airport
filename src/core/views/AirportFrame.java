...
public class AirportFrame extends javax.swing.JFrame {
    ...
    private void generatePassengers() {
        Response response = PassengerController.readPassengers();
    ...
    private void generatePlanes() {
        Response response = PlaneController.readPlanes();
        ...
        if (response.getStatus().getCode() >= 500) {
            ...
            flightRegistrationPlaneBox.addItem(plane.getId());
        }
        }
    }

    private void generateLocations() {
        Response response = LocationController.readLocations();
        ...
        if (response.getStatus().getCode() >= 500) {
            ...
            flightRegistrationDepartureLocationBox.addItem(location.getAirportId());
            flightRegistrationArrivalLocationBox.addItem(location.getAirportId());
            flightRegistrationScaleLocationBox.addItem(location.getAirportId());
        }
        }
    }

    private void generateFlights() {
        Response response = FlightController.readFlights();
        ...
        if (response.getStatus().getCode() >= 500) {
            ...
            addToFlightFlightBox.addItem(flight.getId());
            delayFlightsIDBox.addItem(flight.getId());
        }
        }
    ...
    private void initComponents() {
        ...
        bodyPanel = new core.views.PanelRound();
        upperBodyPanel = new core.views.PanelRound();
        ...
        lowerBodyPanel = new core.views.PanelRound();
    ...
    private void passengerRegistrationRegisterButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_passengerRegistrationRegisterButtonActionPerformed
        ...
        String id = passengerRegistrationIDTextField.getText();
        ...
        String year = passengerRegistrationYearTextField.getText();
        String month = passengerRegistrationMonthBox.getItemAt(passengerRegistrationMonthBox.getSelectedIndex());
        String day = passengerRegistrationDayBox.getItemAt(passengerRegistrationDayBox.getSelectedIndex());
        String phoneCode = passengerRegistrationPhone1TextField.getText();
        String phone = passengerRegistrationPhone2TextField.getText();
        ...
        if (response.getStatus().getCode() >= 500) {
            ...
            passengerRegistrationIDTextField.setText("");
            passengerRegistrationFirtstNameLabel.setText("");
            passengerRegistrationLastNameTextField.setText("");
            passengerRegistrationYearTextField.setText("");
            passengerRegistrationMonthBox.setSelectedIndex(0);
            passengerRegistrationDayBox.setSelectedIndex(0);
            passengerRegistrationPhone1TextField.setText("");
            passengerRegistrationPhone2TextField.setText("");
            passengerRegistrationCountryTextField.setText("");
    ...
    private void airplaneRegistrationCreateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_airplaneRegistrationCreateButtonActionPerformed
        ...
        String maxCapacity = airplaneRegistrationMaxCapacityTextField.getText();
        ...
        if (response.getStatus().getCode() >= 500) {
            ...
            airplaneRegistrationIDTextField.setText("");
            airplaneRegistrationBrandTextField.setText("");
            airplaneRegistrationModelTextField.setText("");
            airplaneRegistrationMaxCapacityTextField.setText("");
            airplaneRegistrationAirlineTextField.setText("");
    ...
    private void locationRegistrationCreateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_locationRegistrationCreateButtonActionPerformed
        ...
        String latitude = locationRegistrationAirportLatitudeTextField.getText();
        String longitude = locationRegistrationAirportLongitudeTextField.getText();
        ...
        if (response.getStatus().getCode() >= 500) {
            ...
            locationRegistrationAirportIDTextField.setText("");
            locationRegistrationAirportNameTextField.setText("");
            locationRegistrationAirportCityTextField.setText("");
            locationRegistrationAirportCountryTextField.setText("");
            locationRegistrationAirportLatitudeTextField.setText("");
            locationRegistrationAirportLongitudeTextField.setText("");
    ...
    private void flightRegistrationCreateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_flightRegistrationCreateButtonActionPerformed
        ...
        String year = flightRegistrationYearTextField.getText();
        String month = flightRegistrationMonthBox.getItemAt(flightRegistrationMonthBox.getSelectedIndex());
        String day = flightRegistrationDayBox.getItemAt(flightRegistrationDayBox.getSelectedIndex());
        String hour = flightRegistrationDepartureHourBox.getItemAt(flightRegistrationDepartureHourBox.getSelectedIndex());
        String minutes = flightRegistrationDepartureMinuteBox.getItemAt(flightRegistrationDepartureMinuteBox.getSelectedIndex());
        String hoursDurationsArrival = flightRegistrationArrivalHourBox.getItemAt(flightRegistrationArrivalHourBox.getSelectedIndex());
        String minutesDurationsArrival = flightRegistrationArrivalMinuteBox.getItemAt(flightRegistrationArrivalMinuteBox.getSelectedIndex());
        String hoursDurationsScale = flightRegistrationScaleHourBox.getItemAt(flightRegistrationScaleHourBox.getSelectedIndex());
        String minutesDurationsScale = flightRegistrationScaleMinuteBox.getItemAt(flightRegistrationScaleMinuteBox.getSelectedIndex());
        ...
        if (response.getStatus().getCode() >= 500) {
            ...
            flightRegistrationIDTextField.setText("");
            flightRegistrationPlaneBox.setSelectedIndex(0);
            flightRegistrationDepartureLocationBox.setSelectedIndex(0);
            flightRegistrationArrivalLocationBox.setSelectedIndex(0);
            flightRegistrationScaleLocationBox.setSelectedIndex(0);
            flightRegistrationYearTextField.setText("");
            flightRegistrationMonthBox.setSelectedIndex(0);
            flightRegistrationDayBox.setSelectedIndex(0);
            flightRegistrationDepartureHourBox.setSelectedIndex(0);
            flightRegistrationDepartureMinuteBox.setSelectedIndex(0);
            flightRegistrationArrivalHourBox.setSelectedIndex(0);
            flightRegistrationArrivalMinuteBox.setSelectedIndex(0);
            flightRegistrationScaleHourBox.setSelectedIndex(0);
            flightRegistrationScaleMinuteBox.setSelectedIndex(0);
    ...
    private void updateInfoUpdateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateInfoUpdateButtonActionPerformed
        ...
        String year = updateInfoYearTextField.getText();
        String month = passengerRegistrationMonthBox.getItemAt(updateInfoMonthBox.getSelectedIndex());
        String day = passengerRegistrationDayBox.getItemAt(updateInfoDayBox.getSelectedIndex());
        String phoneCode = updateInfoPhone1TextField.getText();
        String phone = updateInfoPhone2TextField.getText();
    ...
    private void addToFlightAddButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addToFlightAddButtonActionPerformed
        ...
        if (response.getStatus().getCode() >= 500) {
            ...
            addToFlightFlightBox.setSelectedIndex(0);
        }
    ...
    private void delayFlightsDelayButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_delayFlightsDelayButtonActionPerformed
        ...
        String hours = delayFlightsHourBox.getItemAt(delayFlightsHourBox.getSelectedIndex());
        String minutes = delayFlightsMinuteBox.getItemAt(delayFlightsMinuteBox.getSelectedIndex());
        ...
        if (response.getStatus().getCode() >= 500) {
            ...
            delayFlightsIDBox.setSelectedIndex(0);
            delayFlightsHourBox.setSelectedIndex(0);
            delayFlightsMinuteBox.setSelectedIndex(0);
        }
    ...
    private void showMyFlightsRefreshButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_showMyFlightsRefreshButtonActionPerformed
        ...
        Response response = PassengerController.readPassenger(passengerId);
    ...
    private core.views.PanelRound bodyPanel;
    ...
    private core.views.PanelRound lowerBodyPanel;
    ...
    private core.views.PanelRound upperBodyPanel;
